$(document).ready(function () {
    ...
    $('.home_slider').on('afterChange', function (prevSlide) {
        ...
        $('.home_slider .video').find('iframe').remove();
    ...
    $('.home_slider').on('afterChange', function (currentSlide) {
        ...
        var srcs = $(this).find('.video').attr('data-src')
        $(this).find('.video').append('<iframe></iframe>');
        var iframe = $(this).find('.video').find('iframe');
  ...
  /*  $('.home_slider .video.slick-active i').click(function () {
    ...
    $('.home_slider .video.slick-active i').trigger('click');*/
