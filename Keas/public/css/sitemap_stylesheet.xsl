...
<xsl:stylesheet version="2.0" xmlns:html="http://www.w3.org/TR/REC-html40" xmlns:image="http://www.google.com/schemas/sitemap-image/1.1" xmlns:sitemap="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <html xmlns="http://www.w3.org/1999/xhtml">
            <head>
                <title>Keas Site Haritası</title>
            ...
            <body>
                <div id="main">
                    <h1>Keas Site Haritası</h1>
                    <xsl:if test="sitemap:sitemapindex/sitemap:sitemap">
                        <p>Site haritası toplamda
                            <xsl:value-of select="count(sitemap:sitemapindex/sitemap:sitemap)" /> farklı site haritası kapsamaktadır.
                        </p>
                    </xsl:if>
                    <xsl:if test="sitemap:urlset/sitemap:url">
                        <p>Site haritası toplamda
                            <xsl:value-of select="count(sitemap:urlset/sitemap:url)" /> URL kapsamaktadır.
                        </p>
                    </xsl:if>
                    <div id="sitemaps">
                        <div class="loc">URL</div>
                        <div class="lastmod">Son Güncelleme</div>
                        <ul>
