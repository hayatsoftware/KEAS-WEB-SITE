...
class ParkeFeatures extends DataSource
{
    public function getData()
    {
        return Cache::rememberForever(hash('md5', 'MediapressParkeFeatures' ), function () {
            $data = [];
            $pages = \DB::table('pages')
                ...
                ->where('pages.sitemap_id', PARKE_FEATURES_ST_ID)
