...
class ParkeCertificate extends DataSource
{
    public function getData()
    {
        return Cache::rememberForever(hash('md5', 'MediapressParkeCertificate' ), function () {
            $data = [];
            $pages = \DB::table('pages')
                ...
                ->where('pages.sitemap_id', PARKE_CERTIFICATE_ST_ID)
