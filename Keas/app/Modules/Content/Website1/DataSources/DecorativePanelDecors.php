...
class DecorativePanelDecors extends DataSource
{
    public function getData()
    {
        return Cache::rememberForever(hash('md5', 'MediapressDecorativePanelDecors' ), function () {
            $data = [];
            $pages = \DB::table('pages')
                ...
                ->where('pages.sitemap_id', DECORATIVE_PANEL_DECORS_ST_ID)
