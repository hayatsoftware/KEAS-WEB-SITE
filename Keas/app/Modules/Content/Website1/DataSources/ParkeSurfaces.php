...
class ParkeSurfaces extends DataSource
{
    public function getData()
    {
        return Cache::rememberForever(hash('md5', 'MediapressParkeSurfaces' ), function () {
            $data = [];
            $pages = \DB::table('pages')
                ...
                ->where('pages.sitemap_id', PANEL_SURFACES_ST_ID)
