...
class DoorPanelTextures extends DataSource
{
    public function getData()
    {
        return Cache::rememberForever(hash('md5', 'MediapressDoorPanelTextures' ), function () {
            $data = [];
            $pages = \DB::table('pages')
                ...
                ->where('pages.sitemap_id', DOOR_PANEL_TEXTURES_ST_ID)
