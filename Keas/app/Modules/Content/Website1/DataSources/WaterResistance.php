...
class WaterResistance extends DataSource
{
    public function getData()
    {
        return Cache::rememberForever(hash('md5', 'MediapressWaterResistance' ), function () {
            $data = [];
            $pages = \DB::table('pages')
                ...
                ->where('pages.sitemap_id', WATER_RESISTANCE_ST_ID)
