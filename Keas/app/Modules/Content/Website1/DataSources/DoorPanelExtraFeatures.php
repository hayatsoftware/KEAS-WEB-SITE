...
class DoorPanelExtraFeatures extends DataSource
{
    public function getData()
    {
        return Cache::rememberForever(hash('md5', 'MediapressDoorPanelExtraFeatures' ), function () {
            $data = [];
            $pages = \DB::table('pages')
                ...
                ->where('pages.sitemap_id', DOOR_PANEL_EXTRA_FEATURES_ST_ID)
