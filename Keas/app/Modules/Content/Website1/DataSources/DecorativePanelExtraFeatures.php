...
class DecorativePanelExtraFeatures extends DataSource
{
    public function getData()
    {
        return Cache::rememberForever(hash('md5', 'MediapressDecorativePanelExtraFeatures' ), function () {
            $data = [];
            $pages = \DB::table('pages')
                ...
                ->where('pages.sitemap_id', DECORATIVE_PANEL_EXTRA_FEATURES_ST_ID)
