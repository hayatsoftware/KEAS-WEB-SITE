...
class DecorativePanelCertificate extends DataSource
{
    public function getData()
    {
        return Cache::rememberForever(hash('md5', 'MediapressDecorativePanelCertificate' ), function () {
            $data = [];
            $pages = \DB::table('pages')
                ...
                ->where('pages.sitemap_id', DECORATIVE_PANEL_CERTIFICATE_ST_ID)
